...
const endScoreCard = document.querySelector('.end-score');
const endScore = document.querySelector('.end-score .guessed-capitals');
const allCapitals = document.querySelector('.end-score .all-capitals');
...
const drawTheCountry = () => {
  ...
  if (Object.values(europe).length == 0) {
    ...
    return console.log('nie ma więcej countries');
  } else {
...
const isCapitalRight = () => {
  ...
  if (inputValue.toLowerCase() == capitalOutcome.toLowerCase()) {
    ...
    setTimeout(() => {
      //  img.removeAttribute()
      //  img.setAttribute('src', "./imgs/accept.png")
